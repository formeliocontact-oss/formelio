      ...
      <div className="container prose prose-gray mx-auto max-w-4xl px-4">
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Documents fournis volontairement pour le traitement de vos
              dossiers
            </li>
        ...
        <section>
          ...
          <p>
            ...
            Supabase, conforme au RGPD. Les données sont stockées sur des
            serveurs sécurisés et font l&apos;objet de sauvegardes régulières.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            publicitaire ou de tracking n&apos;est utilisé. Vous pouvez
        ...
        <section>
          ...
          <p>
            ...
            uniquement dans le cadre de l&apos;exécution de nos services
            (greffes, administrations, services techniques). Ces prestataires
            sont soumis aux mêmes obligations de protection des données.
          </p>
        </section>
